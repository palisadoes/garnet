...
def root_directory():
    """Getermine the root directory in which garnet is installed.
    ...
    """
    # Get the directory of the garnet library
    garnet_dir = garnet.__path__[0]
    components = garnet_dir.split(os.sep)
